...
{ 
    ...
    [SerializeField][BoxGroup("Jump")] private float _jumpForce = 200;
    [SerializeField][BoxGroup("Jump")] private float lowGravityScale = 0.5f; // Gravidade reduzida para queda lenta
    ...
    private void FixedUpdate()
    {
        ...
        if (!onGround && isHoldingJump && rb.velocity.y < fallingTreshold){
            ...
            rb.gravityScale = 8f; // Gravidade normal quando no chao ou nao segurando o botao de pulo
        }
    }

    // Funcao para inverter a direcao (flip) do personagem
    private void Flip()
    {
